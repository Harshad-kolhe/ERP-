...
/// can be index-covered â€” instead of the database being asked to sort on arbitrary
...
public sealed class QueryMap<T>
{
    ...
    /// <summary>
    /// Applies filtering, free-text search and ordering. Does not apply paging â€”
