...
/// the string <c>"SA"</c> starts with <c>"S"</c> â€” which is why the legacy code
...
public static class AssemblyLevels
{
    ...
    /// <summary>
    /// As <see cref="Describe"/>, with its indefinite article â€” "an assembly", not
    /// "a assembly".
    /// <para>
    ...
    /// sentence â€” "An assembly must belong to a section."
    /// <para>
