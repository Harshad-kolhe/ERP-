...
namespace Erp.Api.Domain.Customers;
...
/// through <c>[Column]</c> attributes â€” <c>customerCode</c>, <c>billing_state</c>,
/// <c>shipping_zipcode</c> â€” because the table was built by hand before the entity
