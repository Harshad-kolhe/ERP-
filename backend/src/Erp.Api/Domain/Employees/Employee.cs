...
namespace Erp.Api.Domain.Employees;
...
/// contain them â€” see the warning on <see cref="Password"/>.
/// </para>
/// </summary>
public sealed class Employee : AggregateRoot<int>, IAuditable, ISoftDeletable, IBusinessUnitScoped, IHasRowVersion
{
