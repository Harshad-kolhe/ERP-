...
namespace Erp.Api.Domain.HsnCodes;
...
/// part â€” the rate is. Validating the shape (4, 6 or 8 digits) tells you a code is
...
public sealed class HsnCode : AggregateRoot<int>, IAuditable, ISoftDeletable, IHasRowVersion
{
    ...
    /// <para>
    /// The latest rate that had already taken effect â€” not the latest rate on the
