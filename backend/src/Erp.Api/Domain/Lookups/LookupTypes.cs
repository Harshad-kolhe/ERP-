...
/// genuinely shared â€” <see cref="UnitOfMeasure"/> and <see cref="Currency"/> mean
...
public static class LookupTypes
{
    ...
    /// name, but no longer stored in <c>LookupValue</c> â€” the rows moved to
    ...
    /// <para>
    /// Shared by all three levels because it is one list â€” the legacy screens each
    ...
    /// <summary>What powers an assembly â€” motor, hydraulic, pneumatic, manual.</summary>
    ...
    /// than from a table â€” a status is a code path, and a row that invented a fifth
