...
/// opposite choice â€” lines were rows in the same table as headers, addressable by
/// their own endpoints â€” and the result was that adding a child and updating the
...
public sealed class ParentPartComponent : Entity<Guid>
{
    ...
    /// <summary>
    /// Quantity Ã— <see cref="Rate"/>, maintained here and never accepted from the
    /// caller â€” a stored total anybody can post an arbitrary value into is not a
    /// total, and the header sums this column.
    /// </summary>
    public decimal? Amount { get; private set; }

    /// <summary>Quantity Ã— <see cref="UnitWeightKg"/>, on the same terms as <see cref="Amount"/>.</summary>
    ...
    /// the user arranged them in â€” without it the order is whatever the index
