...
/// are not carried over â€” <c>ItemDescription2</c> holds a technical specification,
...
/// </para>
/// </summary>
public sealed record PartAttributes
{
    ...
    /// Unicode: it carries engineering symbols (Î©, Âµ, Ã—, Ã˜) that a non-Unicode column
    ...
    /// <summary>Legacy <c>PartRevisionNo</c> â€” a two-digit revision label, not a number.</summary>
