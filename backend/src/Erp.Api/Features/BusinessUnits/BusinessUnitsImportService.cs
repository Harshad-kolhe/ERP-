...
public sealed class BusinessUnitsImportService(ErpDbContext db)
{
    public const string TemplateContentType =
        "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";

    public const string TemplateSheetName = "BusinessUnits";
    ...
    public static byte[] BuildTemplate() =>
        ExcelTemplateWriter.Build(TemplateSheetName, BusinessUnitImportColumns.All);
