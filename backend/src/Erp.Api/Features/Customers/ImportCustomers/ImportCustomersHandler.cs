...
public sealed record ImportCustomersCommand(ImportFile File);

/// <summary>Loads a sheet of customers. Same shape as <c>ImportPartsHandler</c> â€” see it for the reasoning.</summary>
public sealed class ImportCustomersHandler(ErpDbContext db)
