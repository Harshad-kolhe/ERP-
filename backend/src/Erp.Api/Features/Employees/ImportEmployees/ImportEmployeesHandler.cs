...
public sealed record ImportEmployeesCommand(ImportFile File);
...
/// </para>
/// </summary>
public sealed class ImportEmployeesHandler(ErpDbContext db)
    : ICommandHandler<ImportEmployeesCommand, ImportResultDto>
{
    ...
    /// imports unchanged, and what lands is the readable form â€” the code was an
