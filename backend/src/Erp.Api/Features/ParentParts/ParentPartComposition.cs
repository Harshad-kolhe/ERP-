...
/// </para>
/// </summary>
public static class ParentPartComposition
{
    /// <summary>
        ...
        CancellationToken cancellationToken)
    {
        ...
        // back with them so every failure below can say which part it means â€” an
    ...
    /// â€” which the legacy free-text column could not tell apart from one that did.
    /// </para>
    /// </summary>
