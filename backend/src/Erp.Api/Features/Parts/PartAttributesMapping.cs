...
/// </summary>
public static class PartAttributesMapping
{
    /// <summary>
    /// A null payload becomes an empty set rather than "leave the current values
    /// alone". Update replaces the descriptive fields wholesale â€” see the note on
    /// <see cref="UpdatePartRequest.Attributes"/> â€” and an empty set here is what
