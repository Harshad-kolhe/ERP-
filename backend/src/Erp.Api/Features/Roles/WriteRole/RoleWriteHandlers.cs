...
namespace Erp.Api.Features.Roles.WriteRole;

public sealed record GetRoleMasterByIdQuery(int Id);

public sealed record CreateRoleMasterCommand(CreateRoleMasterRequest Request);

public sealed record UpdateRoleMasterCommand(int Id, UpdateRoleMasterRequest Request);
...
public sealed class GetRoleMasterByIdHandler(ErpDbContext db)
...
public sealed class CreateRoleMasterHandler(ErpDbContext db)
...
public sealed class UpdateRoleMasterHandler(ErpDbContext db)
