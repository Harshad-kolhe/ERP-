...
public sealed record ImportSuppliersCommand(ImportFile File);

/// <summary>Loads a sheet of suppliers. Same shape as <c>ImportPartsHandler</c> â€” see it for the reasoning.</summary>
public sealed class ImportSuppliersHandler(ErpDbContext db)
