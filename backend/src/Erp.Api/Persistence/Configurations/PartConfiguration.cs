...
internal sealed class PartConfiguration : IEntityTypeConfiguration<Part>
{
    public void Configure(EntityTypeBuilder<Part> builder)
    {
        ...
        // varchar one silently folded engineering symbols (Î©, Âµ, Ã—, Ã˜) into their
        ...
        // 'Approved', not '02' â€” the legacy convention that produced 277 bare
        ...
        // "Show me every revision of this part" â€” the query the revision chain
