...
/// <summary>
/// The application's single <see cref="DbContext"/>. Every entity in the system â€”
/// master data and identity alike â€” is mapped here, in one model with one
/// migration history.
/// <para>
...
/// now maps all of it, and a query may join freely across the two â€” which is why
...
/// model â€” never per entity. That distinction is the whole point. The system this
    ...
    : IdentityDbContext<ErpUser, ErpRole, Guid>(options)
{
    ...
    /// <summary>
    /// Sections, assemblies and sub-assemblies â€” one table for all three levels.
    ...
    /// needed conversion factors and precision â€” see <see cref="UnitOfMeasure"/>.
    /// </summary>
    ...
    protected override void ConfigureConventions(ModelConfigurationBuilder configurationBuilder)
    {
        ...
        // explicitly in their entity configuration â€” see Quantity.Scale.
