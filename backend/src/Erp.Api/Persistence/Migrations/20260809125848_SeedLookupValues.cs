...
namespace Erp.Api.Persistence.Migrations
{
    ...
    public partial class SeedLookupValues : Migration
    {
        ...
        {
            migrationBuilder.Sql("DELETE FROM masters.LookupValue;");
        }
        ...
        /// running this migration twice on two machines produces identical rows â€”
        ...
        /// neither alphabetical nor arbitrary â€” a unit list wants NOS first.
        /// </summary>
