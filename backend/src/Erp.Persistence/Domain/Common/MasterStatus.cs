namespace Erp.Persistence.Domain.Common;
...
/// Store Loc" on a GRN and "QC Partial" on the quality flow — which is how a
...
public enum MasterStatus
{
    ...
    /// <summary>Submitted for review. Not editable — the approver must see what they approve.</summary>
    PendingApproval = 1,
    ...
    /// <c>RejectedReason</c>, so the rejection was recorded — but the status went
    ...
    /// <summary>
    /// Approved, but temporarily not to be used — legacy status <c>10</c>.
    /// <para>
    ...
    // saying it twice invites the two to disagree — a record cannot be Approved and
