...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Erp.Persistence.Domain.Assemblies.AssemblyNode", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Erp.Persistence.Domain.BusinessUnits.BusinessUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Erp.Persistence.Domain.Customers.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Erp.Persistence.Domain.Employees.Employee", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Erp.Persistence.Domain.ParentParts.ParentPartComponent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Erp.Persistence.Domain.Parts.Part", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Erp.Persistence.Domain.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Erp.Persistence.Domain.Suppliers.Supplier", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Erp.Persistence.Identity.ErpUser", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Erp.Persistence.Domain.ParentParts.ParentPart", b =>
                {
                    ...
                    b.HasOne("Erp.Persistence.Domain.Parts.Part", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Erp.Persistence.Domain.ParentParts.ParentPartComponent", b =>
                {
                    b.HasOne("Erp.Persistence.Domain.ParentParts.ParentPart", null)
                        .WithMany("Components")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<System.Guid>", b =>
                {
                    b.HasOne("Erp.Persistence.Identity.ErpRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("Erp.Persistence.Identity.ErpUser", null)
                        .WithMany()
