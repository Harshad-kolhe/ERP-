...
namespace Erp.Persistence.Migrations
{
    ...
    public partial class SeedUnitsOfMeasureAndHsnCodes : Migration
    {
        ...
        private static void SeedHsnCodes(MigrationBuilder migrationBuilder)
        {
            ...
            // — chapters 72, 73, 84 and 85. That is a fact about this starting set,
        ...
        /// <c>docs/import/Parts.xlsx</c> — the file the documentation tells an
        /// operator to start from — fail on its own data.
        /// </summary>
        ...
        /// converts the same way for every part. BOX and PKT deliberately have none —
