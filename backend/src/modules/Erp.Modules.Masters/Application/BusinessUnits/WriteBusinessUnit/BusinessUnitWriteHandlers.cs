...
namespace Erp.Modules.Masters.Application.BusinessUnits.WriteBusinessUnit;

internal sealed record GetBusinessUnitByIdQuery(int Id);

internal sealed record CreateBusinessUnitCommand(CreateBusinessUnitRequest Request);

internal sealed record UpdateBusinessUnitCommand(int Id, UpdateBusinessUnitRequest Request);

/// <summary>The one place a business unit's editable fields move between the wire and the entity.</summary>
internal static class BusinessUnitMapping
{
