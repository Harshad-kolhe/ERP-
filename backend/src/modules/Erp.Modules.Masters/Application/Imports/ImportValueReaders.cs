...
internal static class MasterStatusReader
{
    /// <summary>
...
internal static class ImportProvenance
{
    /// <summary>
    ...
    /// asked "where did this record come from?" a year later — the question the
