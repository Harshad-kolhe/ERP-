...
namespace Erp.Modules.Masters.Application.Lookups;
...
/// four-column row cannot hold. Callers should not have to know which is which —
...
internal static class ReferenceCodes
{
    ...
    /// — meaning the caller should read it from <c>LookupValue</c>.
    /// </summary>
    ...
    /// field — a part has twelve coded fields, and checking them a field at a time
    ...
    /// — <c>"Mild steel"</c>. An ordinal comparison here would reject the very rows
    ...
    /// <summary>
    /// Whether a value is one of a list's codes. A blank value is accepted — an
