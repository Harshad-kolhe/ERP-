...
/// </para>
/// </summary>
internal static class MasterValidatorExtensions
{
    ...
    /// <para>
    /// Stricter patterns reject addresses that work — plus-addressing, new top-level
    /// domains, apostrophes — and the only way to actually know an address is real is
    ...
    /// <summary>Five letters, four digits, one letter — the Indian income tax PAN format.</summary>
    ...
    /// <summary>State code, PAN, entity number, Z, check character — the 15-character GSTIN.</summary>
