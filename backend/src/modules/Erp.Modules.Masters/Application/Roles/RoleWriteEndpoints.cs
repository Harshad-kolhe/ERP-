...
using Erp.Modules.Masters.Application.Roles.WriteRole;
...
namespace Erp.Modules.Masters.Application.Roles;

internal sealed class SaveRoleMasterValidator : AbstractValidator<SaveRoleMasterRequest>
{
...
internal sealed class CreateRoleMasterValidator : AbstractValidator<CreateRoleMasterRequest>
{
...
internal sealed class UpdateRoleMasterValidator : AbstractValidator<UpdateRoleMasterRequest>
{
...
/// </para>
/// </summary>
internal sealed class RoleWriteEndpoints : IEndpoint
{
