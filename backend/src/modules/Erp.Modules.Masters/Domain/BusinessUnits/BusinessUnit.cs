...
namespace Erp.Modules.Masters.Domain.BusinessUnits;

/// <summary>
/// A business unit — the tenancy dimension every other record is scoped to.
...
/// </para>
/// </summary>
internal sealed class BusinessUnit : AggregateRoot<int>, IAuditable, ISoftDeletable, IHasRowVersion
{
    /// <summary>
