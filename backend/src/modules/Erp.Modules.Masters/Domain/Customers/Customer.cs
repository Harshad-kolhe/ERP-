...
namespace Erp.Modules.Masters.Domain.Customers;
...
/// </para>
/// </summary>
internal sealed class Customer : AggregateRoot<int>, IAuditable, ISoftDeletable, IBusinessUnitScoped, IHasRowVersion
{
