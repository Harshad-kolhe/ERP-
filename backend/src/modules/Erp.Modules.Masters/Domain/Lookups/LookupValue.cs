...
namespace Erp.Modules.Masters.Domain.Lookups;
...
/// typed straight into the JavaScript — <c>items: ["OutSource", "In House"]</c> —
...
/// tenant for no gain — the first person to add "KG" in one unit would find it
/// missing in the next.
/// </para>
/// </summary>
internal sealed class LookupValue : AggregateRoot<int>, IAuditable, ISoftDeletable, IHasRowVersion
{
    /// <summary>Which list this belongs to — see <see cref="LookupTypes"/>.</summary>
    ...
    /// order that is neither alphabetical nor insertion order — a UOM list wants
    /// NOS first, not AMP.
    /// </summary>
