...
namespace Erp.Modules.Masters.Domain.Suppliers;
...
/// </para>
/// </summary>
internal sealed class Supplier : AggregateRoot<int>, IAuditable, ISoftDeletable, IBusinessUnitScoped, IHasRowVersion
{
