...
internal sealed class AssemblyNodeConfiguration : IEntityTypeConfiguration<AssemblyNode>
{
    ...
    public void Configure(EntityTypeBuilder<AssemblyNode> builder)
    {
        ...
        // 'SubAssembly', not '2' — and unlike the legacy 'S'/'A'/'SA' codes, no
        ...
        // a varchar column folds engineering symbols (Ω, µ, ×, Ø) into look-alikes.
        ...
        // navigation property is declared — the tree is read by projection, and a
        ...
        // Codes are unique per business unit across all three levels — see
        ...
        // "What sits under this node?" — the child count on every grid row, and the
