...
namespace Erp.Modules.Masters.Infrastructure.Migrations
{
    ...
    [Migration("20260808193734_AddAssemblyNodeAndParentPartMasters")]
    partial class AddAssemblyNodeAndParentPartMasters
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Erp.Modules.Masters.Domain.Assemblies.AssemblyNode", b =>
                {
                    b.Property<Guid>("Id")
            ...
            modelBuilder.Entity("Erp.Modules.Masters.Domain.BusinessUnits.BusinessUnit", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Erp.Modules.Masters.Domain.Lookups.LookupValue", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Erp.Modules.Masters.Domain.ParentParts.ParentPart", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Erp.Modules.Masters.Domain.ParentParts.ParentPartComponent", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Erp.Modules.Masters.Infrastructure.ReadModels.AuditUser", b =>
                {
            ...
            modelBuilder.Entity("Erp.Modules.Masters.Domain.Assemblies.AssemblyNode", b =>
                {
                    b.HasOne("Erp.Modules.Masters.Domain.Assemblies.AssemblyNode", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Erp.Modules.Masters.Domain.ParentParts.ParentPart", b =>
                {
                    ...
                    b.HasOne("Erp.Modules.Masters.Domain.Parts.Part", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Erp.Modules.Masters.Domain.ParentParts.ParentPartComponent", b =>
                {
                    b.HasOne("Erp.Modules.Masters.Domain.ParentParts.ParentPart", null)
                        .WithMany("Components")
