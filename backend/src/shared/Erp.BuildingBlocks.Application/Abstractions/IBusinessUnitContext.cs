...
/// <para>
/// Read by the global query filter applied to every <see cref="Erp.SharedKernel.Primitives.IBusinessUnitScoped"/>
/// entity, and by the interceptor that stamps the business unit on insert. No
/// handler calls this directly to filter a query — that was the legacy model, and
