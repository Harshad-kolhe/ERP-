...
namespace Erp.BuildingBlocks.Web.Validation;
...
/// stored procedures that were not in source control — and checked
...
/// validator resolves to an empty sequence instead of a DI failure — and so this
